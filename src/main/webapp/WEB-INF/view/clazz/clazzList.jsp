        ...
        layui.use(['element','table','form','jquery','layer'], function() {
            ...
            form.on('submit(search_btn)', function (data) {
                ...
                table.reload('testReload', {
                    method: 'post',
                    url:"${pageContext.request.contextPath}/clazz/getAllClazzList?gradeName="+grade+"&name="+name,
                    page: {
                        curr: 1 // 重载后从第一页开始
                    }
                });
            ...
            table.on('toolbar(clazzList)', function(obj){ //注：tool 是工具条事件名，test 是 table 原始容器的属性 lay-filter="对应的值"
                ...
                if(layEvent === 'add'){ //添加
                    ...
                    layer.confirm('确定删除选中的数据吗？', function(index) {
                        ...
                        $.ajax({
                            url: "${pageContext.request.contextPath}/clazz/batchdelete",
                            type: 'POST',
...
<div id="editDialog"  style="display:none;">
    <!-- 管理员信息表单 -->
    <form id="editForm" class="layui-form" action="${pageContext.request.contextPath}/clazz/update" method="post">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <label class="layui-form-label">年级 :</label>
                <div class="layui-input-block" >
                    <select id="grade_edit" name="gradeName" lay-filter="grade" style="width: 290px;height:37px; border: 1px solid gold">
                        <option value="17级" style="width: 50px">请选择:</option>
                    </select>
                </div>
            </div>
        </div>
...
<div id="addDialog"  style="display:none;">
    <!-- 管理员信息表单 -->
    <form id="addForm" class="layui-form"  action="${pageContext.request.contextPath}/clazz/add" method="post">
        <div class="layui-form-item">
            <label class="layui-form-label">班级名</label>
            <div class="layui-input-inline">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <label class="layui-form-label">年级 :</label>
                <div class="layui-input-block" >
                    <select id="grade_add" name="gradeName" lay-filter="grade" style="width: 290px;height:37px; border: 1px solid gold">
                        <option value="17级" style="width: 50px">请选择:</option>
                    </select>
                </div>
            </div>
