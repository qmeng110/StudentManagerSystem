        ...
        <div class="layui-side-scroll">
            ...
            <ul class="layui-nav layui-nav-tree"  lay-filter="test">
                ...
                <li class="layui-nav-item layui-nav-itemed">
                    ...
                    <dl class="layui-nav-child">
                        <dd><a href="javascript:;" data-id="1" data-title="学生列表" data-url="/student/studentListPage"
                ...
                <c:if test="${userType==1 }">
                    <li class="layui-nav-item">
                        ...
                        <dl class="layui-nav-child">
                            <dd><a href="javascript:;" data-id="4" data-title="年级列表" data-url="/grade/goGradeListPage"
                    ...
                    <li class="layui-nav-item">
                        ...
                        <dl class="layui-nav-child">
                            <dd><a href="javascript:;" data-id="5" data-title="管理员列表" data-url="${pageContext.request.contextPath}/admin/goToAdminPage"
                ...
                <c:if test="${userType==1||userType==2 }">
                    <li class="layui-nav-item">
                        ...
                        <dl class="layui-nav-child">
                            <dd><a href="javascript:;" data-id="3" data-title="班级列表" data-url="/clazz/goClazzListpage"
                    ...
                    <li class="layui-nav-item">
                        ...
                        <dl class="layui-nav-child">
                            <dd><a href="javascript:;" data-id="2" data-title="教师列表" data-url="/teacher/goToTeacherPage"
...
<div id="editAdmin"  style="display:none;">
    <!-- 管理员信息表单 -->
    <form id="editAdminForm" class="layui-form" action="${pageContext.request.contextPath}/admin/updateAdminPassword" method="post">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" name="name" value="${user.name}" autocomplete="off" class="layui-input" disabled>
            </div>
        </div>
...
<div id="editStu"  style="display:none;">
    <!-- 学生信息表单 -->
    <form id="editStuForm" class="layui-form" action="${pageContext.request.contextPath}/student/updateStudentPassword" method="post">
        <div class="layui-form-item">
...
<div id="editTea"  style="display:none;">
    <!-- 教师信息表单 -->
    <form id="editTeaForm" class="layui-form" action="${pageContext.request.contextPath}/teacher/updateTeacherPassword" method="post">
        <div class="layui-form-item">
            <input type="hidden"  name="id" value="${user.id}">
        </div>
        <div class="layui-form-item">
