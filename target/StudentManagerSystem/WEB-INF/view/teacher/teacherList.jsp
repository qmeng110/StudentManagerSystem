...
<script type="text/html" id="head_toolbar">
        ...
        $(function () {
            ...
            layui.use(['element','table','form','jquery','layer','upload'], function() {
                ...
                var tableIns = table.render({
                    elem:"#adminList",
                    url:"${pageContext.request.contextPath}/teacher/findAllTeacher",
                    height: '400' ,
                ...
                form.on('submit(searche_btn)', function (data) {
                    ...
                    table.reload('testReload', {
                        method: 'post',
                        url:"${pageContext.request.contextPath}/teacher/findAllTeacher?name="+name+"&clazz="+clazz,
                        page: {
                            curr: 1 // 重载后从第一页开始
                        }
                    });
                    ...
                    if(layEvent === 'add'){ //添加
                        ...
                        if (uType==1||uType==2){
                            ...
                            layer.confirm('确定删除选中的数据吗？', function(index) {
                                ...
                                $.ajax({
                                    url: "${pageContext.request.contextPath}/teacher/deleteBatch",
                                    type: 'POST',
    ...
    <div id="addDialog"  style="display:none;">
        <!-- 管理员信息表单 -->
        <form id="addForm" class="layui-form" action="${pageContext.request.contextPath}/teacher/add" method="post">
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    ...
                    <div class="layui-input-block" style="width: 190px;height:37px; border: 1px solid beige" >
                        <select id="clazz_add" name="clazzName" lay-filter="clazz" >
                            <option value="" style="width: 50px">请选择:</option>
                        </select>
                    </div>
                </div>
            </div>
    ...
    <div id="editDialog"  style="display:none;">
        <!-- 管理员信息表单 -->
        <form id="editForm" class="layui-form" action="${pageContext.request.contextPath}/teacher/update" method="post">
